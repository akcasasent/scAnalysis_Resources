...
author: "Anna K. Casasent, PhD & Rachel Dittmar PhD"
date: "`r Sys.Date()`"
...
## libraries 
We will be using the following libraries. These should be available if you are using the server. However, you might need to install them. Note this tutorial was prepared using ```r version$version.string``` and Seurat 4, but should work fine with version 5. 
